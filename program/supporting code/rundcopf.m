% function varargout = rundcopf(casedata, mpopt, fname, solvedcase, A)
...
if nargin < 4
    ...
    if nargin < 3
        ...
        if nargin < 2
            mpopt = mpoption('out.all',0);       %% use default options
            if nargin < 1
                casedata = 'case30mikrogridmaswince'; %% default data file is 'case9.m'
            end
        end
    end
end
